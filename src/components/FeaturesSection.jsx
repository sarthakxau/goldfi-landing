...
const FeaturesSection = () => {
    return (
        <section className="grid grid-cols-1 md:grid-cols-2 border-b border-ink">
            <div className="p-8 md:p-16 flex flex-col justify-center border-b md:border-b-0 md:border-r border-ink bg-bg">
                <span className="inline-block w-12 h-1 bg-[#FF7722] mb-8"></span>
                <h2 className="text-4xl md:text-5xl font-bold uppercase leading-none mb-6 text-ink">
                    The gold account <br />for modern India.
                </h2>
                <p className="text-lg md:text-xl mb-8 max-w-md text-ink">
                    Buy gold directly with UPI and earn up to <span className="bg-[#FF7722] text-bg px-1">5% returns</span> on your holdings, annually. No lock-in periods.
                </p>
