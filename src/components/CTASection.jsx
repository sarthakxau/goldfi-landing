    ...
    return (
        <section className="bg-ink text-bg py-16 md:py-24 px-6 md:px-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <h2 className="text-4xl sm:text-5xl md:text-7xl font-bold uppercase mb-6 md:mb-8 leading-[0.9]">
                    Join the gold<br /> revolution.
                </h2>
                <p className="text-base md:text-xl opacity-80 mb-8 md:mb-12 max-w-xl mx-auto">
